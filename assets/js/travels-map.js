...
(function () {
  ...
  function boundsFor(view) { return view==="domestic"?{minLon:72,maxLon:136,minLat:17,maxLat:55}:{minLon:-180,maxLon:180,minLat:-58,maxLat:84}; }
  ...
  function render(){
    var view=mode,box=boundsFor(view),width=1000,height=view==="domestic"?570:470;
